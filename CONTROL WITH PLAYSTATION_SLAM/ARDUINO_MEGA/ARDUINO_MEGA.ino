...
void setup() {
    ...
    Serial1.begin(9600);    // Nhận lệnh từ ESP32 (RX1 kết nối TX2 của ESP32)
...
void loop() {
    ...
    // Nhận lệnh điều khiển từ ESP32 chuyển sang qua Serial1 (Thay thế bàn phím bằng tay cầm)
    if (Serial1.available() > 0) {
        ...
        while(Serial1.available()) Serial1.read(); // Xóa sạch bộ đệm
    }
